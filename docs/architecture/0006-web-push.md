...
- Status: Accepted; implemented as migration `0022_web_push.sql`, released in `v2.0.0`
- Date: 2026-08-15
...
No open product decisions remained; implementation followed as migration `0022_web_push.sql`, released in `v2.0.0`.
